        ...
        <form action="{{ route('admin.categories.destroy' ,$category->id )}}" method="post">
            ...
            <div class="modal-content border-danger">
                <div class="modal-header border-danger">
                    <h3 class="modal-title border-danger">
                        <i class="fa-regular fa-pen-to-square"></i> Delete Category
                    </h3>
                </div>
                <div class="modal-body">
                    <p>Are you sure want to delete <span class="fw-bold">{{ $category->name}}</span> category </p>
                    <p class="fw-light">This action will affect all the posts under this category. Posts without a category will
                        fall under uncategorized.</p>
                </div>
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-outline-warning btn-sm" data-bs-dismiss="modal">Cancel</button>
